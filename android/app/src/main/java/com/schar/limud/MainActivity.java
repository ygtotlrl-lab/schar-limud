...
/**
 * The schar-limud shell — identity only.
 *
 ...
 *
 * <p>אין כאן גשר מקורי: בקוד של שכר לימוד אין `navigator.share`. ⚠️ והנתונים
 * כאן הם כסף — לכן אזהרת מעבר ה-origin שב-`android/README.md` חלה בכפליים.
 */
