...
const APP = {
   ...
   *  נרשם כאן. */
  unsignedAllow: {
    pcChildKill: 'בונה את שורת הבן שיורשת את מחיקת האב ואת חותמתו — ⚠️ שתי אפליקציות נושאות אותה, ⛔ ובשאר אין בן עצמאי שיירש: ⭐ בלוק חתום שקיים בשתיים בלבד היה מדלג בשתיהן ואינו נמדד באף אחת',
  },
};
/* ── סוף APP ───────────────────────────────────────────────────────────── */
