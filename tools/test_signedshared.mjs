...
const APP = {
  ...
  unsignedAllow: {
    ...
    openModal: 'שכבת המודאלים — ⛔ מיכל אחד ומסלול סגירה יחיד, ⚠️ ושלושת האתרים אינם בבלוק חתום',
    closeModal: 'שכבת המודאלים — ⛔ מיכל אחד ומסלול סגירה יחיד, ⚠️ ושלושת האתרים אינם בבלוק חתום',
    closeAsk: 'שכבת המודאלים — ⛔ מיכל אחד ומסלול סגירה יחיד, ⚠️ ושלושת האתרים אינם בבלוק חתום',
  },
};
/* ── סוף APP ───────────────────────────────────────────────────────────── */
