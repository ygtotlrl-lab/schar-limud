...
const APP = {
   ...
   *  דפוס שאין לו אף אתר במקור. ⭐ **ולמה אינדקס ולא עוטף**: ההגדרות
   *  נטענות למפה אחת בסנכרון, ⚠️ ואתרי הקריאה מאנדקסים אותה בשם. */
  cfgReads: [
    { re: "SETTINGS\\[\\s*'([a-z_0-9]+)'\\s*\\]", why: 'אינדקס במפת ההגדרות שנטענה בסנכרון' },
  ],
