...
const APP = {
   ...
   *  השורה השתנתה. */
  dataEra: { base: 1, era: 2, why: 'שכבת האימוץ ירדה ב⚠️ ורשומת מראה שנכתבה לפניה נושאת שמות מזהים שאין להם קורא: ⭐ הצורה השתנתה, ⛔ והעותק המקומי נזרק פעם אחת' },
  ...
  tag: (r) => r && r.name,
  pendKey: (id) => 'c:' + id,
  merge: (sb, local, remote) => sb.slMerge(local, remote, (k) => sb.pendIs(k), sb.slKey),
