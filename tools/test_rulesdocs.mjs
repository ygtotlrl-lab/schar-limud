...
const APP = {
  app: 'schar-limud',  cachePrefix: 'schar-limud-',
  ...
  classNoRule: {},
  dynamicIds: ['acc-', 'panel-', 'sd-input-', 'sd-list-'],
...
const FLOOR = { shared: 24, app: 4, appWhy: 'מספר השערים והבודקים שהריפו נושא — כל שער פרטי מוסיף טענת תוכן' };
/* ⚠️ סוף פר-אפליקציה */
