...
const APP = {
  ...
  exportFns: [],
  gapRows: [64, 68, 92, 95, 111, 114, 115, 118, 119, 123, 125, 130, 133, 143],
  ...
  tableProbe: {
     ...
     *  ניתנת למדידה במלואה. */
    127: (c) => c.hasCode(/SL_PASS_ITER_USER\s*=\s*100000\b/)
