...
const APP = {
  ...
  /*  ⛔ מנוע התאריך העברי נעדר כאן במכוון — ⚠️ נמדדו אפס צרכני
  ...
  /*  ⛔ כאן **יש** מסלול השלמה — ⚠️ ואין כאן מסך ניהול משתמשים:
  ...
  tableProbe: {
    ...
    /*  ⛔ ערך ולא קיום — ⚠️ המסלול החלקי הוא **פונקציה שנקראת
...
/*  ⭐ נעילת חוסר-פעילות. ה-probe דורש את **שני** התנאים:
  ...
  /*  ⛔ ❌ מנומק — אין כאן מסך ניהול משתמשים, ואין לא
