...
const APP = {
  ...
  gapRows: [217, 48, 82, 136, 140, 164, 175, 68, 182, 149, 98],
  ...
  tableProbe: {
     ...
     *  ניתנת למדידה במלואה. */
    186: (c) => c.hasCode(/SL_PASS_ITER_USER\s*=\s*100000\b/)
