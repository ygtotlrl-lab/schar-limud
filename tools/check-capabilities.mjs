...
const APP = {
  ...
  gapRows: [38, 71, 110, 114, 135, 143, 56, 149],
...
const MATRIX = [
  ...
  { row: 83, name: 'פריסה במסכי טלפון וטאבלט',
  ...
  { row: 84, name: 'ערכת נושא — בהיר וכהה',
  ...
  { row: 73, name: 'מיכל המודאל ילד ישיר של `body`',
  ...
  { row: 93, name: 'פונקציה משותפת אינה יוצאת בשקט',
  ...
  { row: 138, name: 'הגיבוי שלם ומעומד',
    probe: () => {
  ...
  { row: 69, name: 'פעולה מגיבה מיד',
    probe: () => actNoFeedback().length === 0 },
  { row: 70, name: 'משיכה מסוננת בשרת', app: true },
  ...
  { row: 143, name: 'מיזוג מכל — מפה ומערך',
  ...
  { row: 144, name: 'רשימה אינה נושאת פריט כפול',
  ...
  { row: 139, name: '`kv_backup` — טבלת הגיבוי',
  ...
  { row: 133, name: 'דפוס `upsert` — onConflict מוכרז', app: true },
  ...
  { row: 120, name: 'עריכת נתונים אופליין',
  ...
  { row: 142, name: 'מחיקה רכה בלבד — אין `DELETE` פיזי',
  ...
  { row: 67, name: 'אובייקט יקר נבנה פעם אחת',
  ...
  { row: 68, name: 'מסך מציג מיד ומרענן ברקע',
  ...
  { row: 146, name: 'אימות פינוי מול הענן',
    probe: () => perKeyWitness() && witnessFed() },
  { row: 114, name: 'שיתוף קבצים',
    probe: () => hasCode(/_androidShareImage|navigator\s*\.\s*share\b/) },
  { row: 99, name: 'מעטפת APK (WebView)',
   ...
   *  שמתיישן בכל שחרור. */
  { row: 102, name: 'אין נכסים מוטבעים',
    probe: () => !hasPath('android/app/src/main/assets/index.html') &&
                 !hasPath('android/app/src/main/assets/sw.js') },
  { row: 118, name: 'מפתח חתימה קבוע בריפו',
    probe: () => keystoreFixed() },
  { row: 123, name: 'מקור אמת יחיד לסכימה', probe: () => schemaSingleSource() },
  { row: 124, name: 'קובץ התקנה מלא',       probe: () => schemaIdempotent() },
  { row: 52, name: 'גיבוי יומי אוטומטי',   probe: () => present.backup === true },
  { row: 52, name: 'יומן פעולות',          probe: () => present.log === true },
  { row: 121, name: 'נתונים בטבלאות מובנות', app: true },
  ...
  { row: 94, name: 'רישום כשלי כתיבה', probe: () => silentWriteCatches().length === 0 },
  ...
  { row: 170, name: 'מטמון-CDN מראש עם ריפוי עצמי',
  ...
  { row: 137, name: 'פינוי גיבויים אוטומטי במסד',
  ...
  { row: 54, name: 'מנוע מיזוג — ⏳ שובר שוויון',
   ...
   *  ⛔ ולא `NaN`. */
  { row: 55, name: 'מזהה אינו מומר למספר',
  ...
  { row: 99, name: 'מעטפת WebView חתומה',
  ...
  { row: 116, name: 'בניית APK אחידה עם שער חתימה',
    probe: () => {
  ...
  { row: 170, name: 'מודול ה-service worker',
...
/*  ⭐ סבב 52 — נעילת חוסר-פעילות. ה-probe דורש את **שני** התנאים:
  ...
  { row: 63, name: 'מודל הסשן — בזיכרון בלבד',
  ...
  { row: 169, name: 'בדיקת עדכון תקופתית ל-service worker',
  ...
  { row: 81, name: 'פסק זמן אחיד לקריאות רשת',
   ...
   *  ולא רק מוגדרים. */
  { row: 141, name: 'גריעת tombstones לפי גיל',
    probe: () => {
  ...
  { row: 168, name: 'עדכון אוטומטי — בדיקה מחזורית',
  ...
  { row: 66, name: 'מיון אחד לכל התצוגות',
  ...
  { row: 71, name: 'ייצוא — שני דפוסים מוצהרים',
    probe: () => exportMarkupSites().length === 0 },
  { row: 106, name: 'שכבת אייקונים',
    probe: () => memoByHash('icons', ICON_SIG(), () => iconAudit('.')).length === 0 },
  { row: 147, name: 'שכבת קלט אחידה',
  ...
  { row: 147, name: 'קריאת ערך מספרי עוברת ב-readNum',
...
const GATES = {
  ...
  60:  { claim: 'שכבת הדחיפה' },
  61: { claim: 'כתיבת משתמש' },
  128: { claim: 'בעלות הסכימה המשותפת' },
  140: { claim: '`kv_rishon`' },
  164: { claim: 'ז. עמודה בלי קורא' },
  166: { claim: 'ח. הגדרה שהוחלפה' },
  ...
  104: { claim: ['gen-icons', 'מצהיר את ', 'ריק נושא הערת נימוק במקומו'] },
  107: { claim: 'margin' },
  ...
  92: { manual: '«סטייה מדפוס» היא קריאת משמעות — ⛔ נסרקת ידנית בכל סבב שנוגע' },
  ...
  50: { claims: { 'check-capabilities': ['sha:', 'orderGaps', 'blockRowGaps'],
  ...
  89: { claim: 'מפנה לקובץ' },
  103: { claim: 'android/app/src/main' },
  110: { claim: 'fgDriftMax' },
  111: { claim: 'CANON_MANIFEST' },
  112: { claim: 'שדות זהים' },
  115: { claim: 'BUILD_SHA' },
  119: { claim: 'SHARED_SHA' },
  117: { claim: 'versionCode' },
  100: { claim: 'WebView' },
  101: { claim: 'android:theme' },
  105: { claim: ['מיקום המאסטר אינו מזיז', 'שהמסכה החתוכה היא כל מקורם'] },
  122: { manual: 'הנפילה-חזרה ביומן נסרקת ידנית; ⛔ קיום המפתחות במסד אינו נראה מהריפו' },
  125: { claim: 'migrations' },
  132: { manual: 'ההרשאות יושבות במסד ואינן נראות מהריפו — אימות הוא פעולת מנהל' },
  134: { claim: 'א. חותמת בכל רשומה' },
  51: { claims: { 'check-capabilities': 'רענון הממתינים', test_push: 'ה. כשל רשת' } },
  129: { claims: { 'check-capabilities': 'colPatternGaps', test_dbfacts: 'ה. דפוס עמודות אחיד' } },
  130: { claim: 'ו. טבלה מקבילה' },
  ...
  165: { claim: 'ד. רשימת-היתר' },
  167: { manual: 'מצב הענפים המרוחקים אינו נראה מעותק העבודה' },
  ...
  87: { manual: '«קורא סביר יופתע» אינו נגזר מהטקסט — ⛔ נאכף בתוצאתו בלבד' },
  95: { claim: 'CLEANUP_SHA' },
  96: { claim: 'בלוק ה-APP' },
  145: { claims: { 'check-capabilities': 'cfgKeyGaps', test_dbfacts: 'ג. כל מפתח שהקוד מבקש' } },
};
