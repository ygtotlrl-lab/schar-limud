...
const APP = {
  ...
  exportFns: [],
  gapRows: [66, 70, 94, 97, 113, 116, 117, 120, 121, 125, 127],
  ...
  tableProbe: {
     ...
     *  ניתנת למדידה במלואה. */
    129: (c) => c.hasCode(/SL_PASS_ITER_USER\s*=\s*100000\b/)
