...
const APP = {
  ...
  gapRows: [41, 74, 115, 119, 141, 150, 59, 157, 128],
  ...
  tableProbe: {
     ...
     *  ניתנת למדידה במלואה. */
    161: (c) => c.hasCode(/SL_PASS_ITER_USER\s*=\s*100000\b/)
  ...
  enterExempt: [
    { field: 'sd-input-txnfilter', why: 'סינון התנועות — אין בכרטיס כפתור שמירה' },
    { field: 'sd-input-sc', why: 'חיפוש תלמיד — אין בכרטיס כפתור שמירה' },
  ],
...
const FLOOR = { shared: 155, app: 9, appWhy: 'כניסה — סשן · נעילה · הרשאות · כתיבת משתמש · שכבת המראה; ומעליו שער מצב הרשת' };
/* ⚠️ סוף פר-אפליקציה */
