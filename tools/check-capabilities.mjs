...
const APP = {
  ...
  exportFns: [],
  gapRows: [67, 71, 95, 99, 115, 116, 120, 121, 124, 126, 130, 132],
  ...
  tableProbe: {
     ...
     *  ניתנת למדידה במלואה. */
    134: (c) => c.hasCode(/SL_PASS_ITER_USER\s*=\s*100000\b/)
