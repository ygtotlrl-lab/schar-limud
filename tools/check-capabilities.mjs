...
const APP = {
   ...
   *  ⛔ ובשום מקרה מסמך HTML שני: ⭐ ⛔ ריק ⛔ ואינו נשמט — ⚠️ אין כאן מסלול ייצוא: ⭐ שדה חסר נקרא «לא נשאל», וריק נקרא «נמדד ואין». */
  ...
  actMap: 'DOM_ACTIONS',
  gapRows: [38, 67, 104, 108, 126, 127, 131, 141, 143],
  ...
  tableProbe: {
     ...
     *  ניתנת למדידה במלואה. */
    145: (c) => c.hasCode(/SL_PASS_ITER_USER\s*=\s*100000\b/)
