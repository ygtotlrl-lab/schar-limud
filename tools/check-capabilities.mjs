...
const APP = {
  ...
  gapRows: [41, 73, 118, 122, 144, 153, 59, 160, 131],
  ...
  tableProbe: {
     ...
     *  ניתנת למדידה במלואה. */
    164: (c) => c.hasCode(/SL_PASS_ITER_USER\s*=\s*100000\b/)
...
const FLOOR = { shared: 81, app: 11, appWhy: 'כניסה — סשן · נעילה · הרשאות · כתיבת משתמש · שכבת המראה; ומעליו שער מצב הרשת; ומעליהם שני בלוקי גרף העמודות' };
/* ⚠️ סוף פר-אפליקציה */
