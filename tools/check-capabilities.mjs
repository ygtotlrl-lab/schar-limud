...
const APP = {
  ...
  gapRows: [218, 48, 82, 137, 141, 165, 176, 68, 183, 150, 98],
  ...
  tableProbe: {
     ...
     *  ניתנת למדידה במלואה. */
    187: (c) => c.hasCode(/SL_PASS_ITER_USER\s*=\s*100000\b/)
