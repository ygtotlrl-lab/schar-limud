...
const APP = {
  ...
  gapRows: [226, 81, 144, 148, 172, 183, 67, 191, 157, 101],
...
const FLOOR = { shared: 90, app: 10, appWhy: 'כניסה — סשן · נעילה · הרשאות · כתיבת משתמש · שכבת המראה; ומעליהם שני בלוקי גרף העמודות' };
/* ⚠️ סוף פר-אפליקציה */
