...
const APP = {
  ...
  gapRows: [41, 74, 114, 118, 139, 147, 59, 153],
  ...
  tableProbe: {
     ...
     *  ניתנת למדידה במלואה. */
    157: (c) => c.hasCode(/SL_PASS_ITER_USER\s*=\s*100000\b/)
...
const FLOOR = { shared: 151, app: 9, appWhy: 'כניסה — סשן · נעילה · הרשאות · כתיבת משתמש · שכבת המראה; ומעליו שער מצב הרשת' };
/* ⚠️ סוף פר-אפליקציה */
