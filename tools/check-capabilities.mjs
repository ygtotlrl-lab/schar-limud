...
const APP = {
  ...
  gapRows: [214, 48, 82, 135, 139, 163, 174, 68, 181, 148, 98],
  ...
  tableProbe: {
     ...
     *  ניתנת למדידה במלואה. */
    185: (c) => c.hasCode(/SL_PASS_ITER_USER\s*=\s*100000\b/)
