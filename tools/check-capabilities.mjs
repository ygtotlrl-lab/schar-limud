...
const APP = {
  ...
  gapRows: [221, 48, 82, 138, 142, 166, 177, 68, 184, 151, 99],
  ...
  tableProbe: {
     ...
     *  ניתנת למדידה במלואה. */
    188: (c) => c.hasCode(/SL_PASS_ITER_USER\s*=\s*100000\b/)
