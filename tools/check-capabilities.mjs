...
const APP = {
  ...
  // ⚠️ שורה 7 «לא רלוונטי» — אין כאן פינוי כלל (שורה 6), ולכן אין מה לאמת.
  ...
  tableProbe: {
     ...
     *  ניתנת למדידה במלואה. */
    105: (c) => c.hasCode(/SL_PASS_ITER_USER\s*=\s*100000\b/)
