...
const APP = {
  ...
  gapRows: [44, 73, 121, 125, 148, 157, 59, 164, 134],
  ...
  tableProbe: {
     ...
     *  ניתנת למדידה במלואה. */
    168: (c) => c.hasCode(/SL_PASS_ITER_USER\s*=\s*100000\b/)
...
const MATRIX = [
  ...
  { row: 152, name: '`sh_backup` — טבלת הגיבוי',
