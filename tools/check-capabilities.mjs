...
const APP = {
  ...
  exportFns: [],
  gapRows: [67, 72, 97, 101, 117, 118, 122, 123, 126, 128, 132, 134],
  ...
  tableProbe: {
     ...
     *  ניתנת למדידה במלואה. */
    136: (c) => c.hasCode(/SL_PASS_ITER_USER\s*=\s*100000\b/)
