...
const APP = {
  ...
  gapRows: [41, 74, 114, 118, 140, 148, 59, 155, 127],
  ...
  tableProbe: {
     ...
     *  ניתנת למדידה במלואה. */
    159: (c) => c.hasCode(/SL_PASS_ITER_USER\s*=\s*100000\b/)
...
const FLOOR = { shared: 153, app: 9, appWhy: 'כניסה — סשן · נעילה · הרשאות · כתיבת משתמש · שכבת המראה; ומעליו שער מצב הרשת' };
/* ⚠️ סוף פר-אפליקציה */
