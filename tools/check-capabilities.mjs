...
const APP = {
  ...
  gapRows: [48, 80, 131, 135, 159, 169, 66, 176, 144, 95],
  ...
  tableProbe: {
     ...
     *  ניתנת למדידה במלואה. */
    180: (c) => c.hasCode(/SL_PASS_ITER_USER\s*=\s*100000\b/)
...
const FLOOR = { shared: 86, app: 10, appWhy: 'כניסה — סשן · נעילה · הרשאות · כתיבת משתמש · שכבת המראה; ומעליהם שני בלוקי גרף העמודות' };
/* ⚠️ סוף פר-אפליקציה */
