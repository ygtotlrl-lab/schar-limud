...
const APP = {
  ...
  gapRows: [39, 72, 111, 115, 136, 144, 57, 150],
  ...
  tableProbe: {
     ...
     *  ניתנת למדידה במלואה. */
    152: (c) => c.hasCode(/SL_PASS_ITER_USER\s*=\s*100000\b/)
...
export const ROWS = [28, 38, 40, 42, 51, 80, 45, 146, 91, 130, 52, 22, 57, 24];
...
const CAPS = {
  ...
  uihelp: {
    ...
    block: { sha: 'ab430fc16264deff', lines: 107,
...
const CAT_ORDER = [
  ...
  { g: 'י', phases: [{ p: 'קלט', w: ['שדה מספרי', 'שדות סיסמה'] },
                     { p: 'כניסה', w: ['שכבת כניסה', 'מראת המשתמשים', '`PBKDF2`',
                                        'מלח אקראי', 'כניסה אופליין'] },
...
const MATRIX = [
  ...
  { row: 137, name: 'הקשר נלכד בכניסה לפונקציה',
  ...
  { row: 84, name: 'פריסה במסכי טלפון וטאבלט',
  ...
  { row: 85, name: 'ערכת נושא — בהיר וכהה',
  ...
  { row: 160, name: 'הערה שמתארת מצב שחלף',
  ...
  { row: 74, name: 'מיכל המודאל ילד ישיר של `body`',
  ...
  { row: 94, name: 'פונקציה משותפת אינה יוצאת בשקט',
  ...
  { row: 139, name: 'הגיבוי שלם ומעומד',
    probe: () => {
  ...
  { row: 136, name: 'החלפת הקשר מאפסת את כל המצב', app: true },
  ...
  { row: 70, name: 'פעולה מגיבה מיד',
    probe: () => actNoFeedback().length === 0 },
  { row: 71, name: 'משיכה מסוננת בשרת', app: true },
  ...
  { row: 110, name: 'דגימת-יתר במחולל',
    probe: () => Number((/^const SS = (\d+);/m.exec(genSrc()) || [])[1]) === GEN_SS },
  { row: 152, name: '`PBKDF2` — פרמטרים', app: true },
  { row: 127, name: '`migrations/` — תוכן',
    probe: () => migContentGaps().length === 0 },
  { row: 128, name: '`migrations/` — כמות',
  ...
  { row: 144, name: 'מיזוג מכל — מפה ומערך',
  ...
  { row: 145, name: 'רשימה אינה נושאת פריט כפול',
  ...
  { row: 26, name: 'שער ממתין לתנאי ולא לשעון',
  ...
  { row: 156, name: 'סודות אינם עוזבים את המכשיר',
    probe: () => {
  ...
  { row: 134, name: 'דפוס `upsert` — onConflict מוכרז', app: true },
  ...
  { row: 154, name: 'טביעה חסרה מושלמת אוטומטית',
  ...
  { row: 154, name: 'כניסה אופליין',
    probe: () => !!(APP.offlineLoginFn && fnRange(APP.offlineLoginFn)) },
  { row: 121, name: 'עריכת נתונים אופליין',
  ...
  { row: 143, name: 'מחיקה רכה בלבד — אין `DELETE` פיזי',
  ...
  { row: 155, name: 'סיסמאות בענן — אין מסלול שכותב או קורא טקסט גלוי',
    probe: () => {
  ...
  { row: 68, name: 'אובייקט יקר נבנה פעם אחת',
  ...
  { row: 69, name: 'מסך מציג מיד ומרענן ברקע',
  ...
  { row: 114, name: 'האפליקציה ניתנת להתקנה מכרום',
    probe: () => installGaps().length === 0 },
  { row: 158, name: 'דגלי מעבר — אין דגל דלוק',
    probe: () => legacyFlagsOn().length === 0 },
  { row: 75, name: 'טיפול באירועים — דלגציה ממאזין אחד',
    probe: () => {
  ...
  { row: 151, name: 'נתיב עדכון חלקי למראת המשתמשים', app: true },
  ...
  { row: 39, name: 'ארבעת מימדי הסריקה',
    probe: () => {
  ...
  { row: 147, name: 'אימות פינוי מול הענן',
    probe: () => perKeyWitness() && witnessFed() },
  { row: 115, name: 'שיתוף קבצים',
    probe: () => hasCode(/_androidShareImage|navigator\s*\.\s*share\b/) },
  { row: 100, name: 'מעטפת APK (WebView)',
   ...
   *  שמתיישן בכל שחרור. */
  { row: 103, name: 'אין נכסים מוטבעים',
    probe: () => !hasPath('android/app/src/main/assets/index.html') &&
                 !hasPath('android/app/src/main/assets/sw.js') },
  { row: 119, name: 'מפתח חתימה קבוע בריפו',
    probe: () => keystoreFixed() },
  { row: 124, name: 'מקור אמת יחיד לסכימה', probe: () => schemaSingleSource() },
  { row: 125, name: 'קובץ התקנה מלא',       probe: () => schemaIdempotent() },
  { row: 53, name: 'גיבוי יומי אוטומטי',   probe: () => present.backup === true },
  { row: 53, name: 'יומן פעולות',          probe: () => present.log === true },
  { row: 122, name: 'נתונים בטבלאות מובנות', app: true },
  ...
  { row: 78, name: '`toast` — חתימה, גוף ומחלקות',
  ...
  { row: 95, name: 'רישום כשלי כתיבה', probe: () => silentWriteCatches().length === 0 },
  ...
  { row: 150, name: 'מסך שינוי סיסמה עצמי', app: true },
  { row: 171, name: 'מטמון-CDN מראש עם ריפוי עצמי',
  ...
  { row: 138, name: 'פינוי גיבויים אוטומטי במסד',
   ...
   *  ⛔ ולא `NaN`. */
  { row: 56, name: 'מזהה אינו מומר למספר',
  ...
  { row: 100, name: 'מעטפת WebView חתומה',
  ...
  { row: 154, name: 'אימות מול טביעה בענן',
    probe: () => {
  ...
  { row: 117, name: 'בניית APK אחידה עם שער חתימה',
    probe: () => {
  ...
  { row: 171, name: 'מודול ה-service worker',
...
/*  ⭐ סבב 52 — נעילת חוסר-פעילות. ה-probe דורש את **שני** התנאים:
  ...
  { row: 64, name: 'מודל הסשן — בזיכרון בלבד',
  ...
  { row: 170, name: 'בדיקת עדכון תקופתית ל-service worker',
  ...
  { row: 82, name: 'פסק זמן אחיד לקריאות רשת',
   ...
   *  ולא רק מוגדרים. */
  { row: 142, name: 'גריעת tombstones לפי גיל',
    probe: () => {
  ...
  { row: 169, name: 'עדכון אוטומטי — בדיקה מחזורית',
  ...
  { row: 67, name: 'מיון אחד לכל התצוגות',
  ...
  { row: 72, name: 'ייצוא — שני דפוסים מוצהרים',
    probe: () => exportMarkupSites().length === 0 },
  { row: 107, name: 'שכבת אייקונים',
    probe: () => memoByHash('icons', ICON_SIG(), () => iconAudit('.')).length === 0 },
  { row: 148, name: 'שכבת קלט אחידה',
...
const GATES = {
  ...
  61:  { claim: 'שכבת הדחיפה' },
  62: { claim: 'כתיבת משתמש' },
  129: { claim: 'בעלות הסכימה המשותפת' },
  141: { claim: '`kv_rishon`' },
  165: { claim: 'ז. עמודה בלי קורא' },
  167: { claim: 'ח. הגדרה שהוחלפה' },
  ...
  105: { claim: ['gen-icons', 'מצהיר את ', 'ריק נושא הערת נימוק במקומו'] },
  108: { claim: 'margin' },
  34: { manual: 'השוואת זמנים בין הריפו אינה בהישג ידו של שער שרץ בריפו אחד — ⛔ נאכפת בתוצאתה בלבד' },
  46: { manual: 'המדידה שלפני המחיקה היא התנהגות סשן — ⛔ נאכפת רק בתוצאתה, בשער ההסרות' },
  45: { claim: 'אין פרק פערים נפרד' },
  93: { manual: '«סטייה מדפוס» היא קריאת משמעות — ⛔ נסרקת ידנית בכל סבב שנוגע' },
   ...
   *  מוטציה שאין בו. */
  29: { claim: 'לכל אחד שינוי, תווית' },
  30: { claim: 'שם הטענה שתיפול' },
  28: { claim: 'כיסוי הטבלה' },
  37: { claim: 'ועמודת התקן שלה אוסרת במפורש' },
  38: { claim: ['מספור רציף ובלי כפילויות', 'nameSignGaps', 'catOrderGaps'] },
  40: { claim: 'הערה ריקה' },
  42: { claim: 'COUNT_NOTE' },
  43: { manual: 'עדכון הסימון הוא התנהגות סשן שאינה בעץ — ⛔ נאכף רק בתוצאתו' },
  172: { claim: 'CACHE_NAME' },
  36: { manual: 'מספר בדיווח הוא התנהגות סשן שאינה בעץ — ⛔ אין קובץ שאפשר למדוד בו את הדיווח, ⚠️ ונאכף בתוצאתו בלבד' },
  22: { claims: { test_readonly: 'drift', 'check-capabilities': 'writeGateGaps' } },
  27: { claim: 'measure-gap',
        manual: 'הצד השני של השורה — ⛔ «אותה טענה» היא קריאת משמעות, ונסרק ידנית בכל סבב שנוגע' },
  31: { claim: 'תווית מוטציה מודפסת' },
  19: { claim: 'תקן הבאנר' },
  16: { claim: 'דפוס הבודקים' },
  35: { claim: 'מספרי הבאנר' },
  ...
  24: { claims: { 'check-comments': 'ריצת check-js', 'check-capabilities': 'gateKindGaps' } },
  ...
  32: { claim: 'BUDGET_MS' },
  33: { claim: 'תקציב זמן לסט' },
  25: { claim: 'ברירת המחדל אינה המהירה' },
  ...
  89: { claim: 'עברית' },
  91: { claims: { 'check-comments': 'RULE_W', 'check-capabilities': 'bannerGaps' } },
  92: { claim: 'BANNER_W' },
  163: { claim: ['אין מחלקת CSS שאינה מוחלת לעולם', 'אין מזהה id שאין לו קורא'] },
  41: { claim: 'פתיחת ההערה בטבלה',
        manual: '«למה ולא מה» הוא קריאת משמעות — ⛔ שער מודד צורה בלבד, ⚠️ ונסרק ידנית' },
  90: { claim: 'מפנה לקובץ' },
  104: { claim: 'android/app/src/main' },
  111: { claim: 'fgDriftMax' },
  112: { claim: 'CANON_MANIFEST' },
  113: { claim: 'שדות זהים' },
  116: { claim: 'BUILD_SHA' },
  120: { claim: 'SHARED_SHA' },
  118: { claim: 'versionCode' },
  101: { claim: 'WebView' },
  102: { claim: 'android:theme' },
  106: { claim: ['מיקום המאסטר אינו מזיז', 'שהמסכה החתוכה היא כל מקורם'] },
  123: { manual: 'הנפילה-חזרה ביומן נסרקת ידנית; ⛔ קיום המפתחות במסד אינו נראה מהריפו' },
  126: { claim: 'migrations' },
  133: { manual: 'ההרשאות יושבות במסד ואינן נראות מהריפו — אימות הוא פעולת מנהל' },
  135: { claim: 'א. חותמת בכל רשומה' },
  52: { claims: { 'check-capabilities': 'רענון הממתינים', test_push: 'ה. כשל רשת' } },
  130: { claims: { 'check-capabilities': 'colPatternGaps', test_dbfacts: 'ה. דפוס עמודות אחיד' } },
  131: { claim: 'ו. טבלה מקבילה' },
  132: { claim: 'ב. חתימת סכימה' },
  149: { claim: 'type=password' },
  77: { claim: 'aria-label' },
  ...
  57: { claims: { 'check-capabilities': ['hebdate', 'monthFormGaps'] } },
  153: { claim: 'pass_salt' },
  157: { manual: 'היעדר סוד נסרק ידנית; ⛔ שער טקסטואלי היה נכשל על כל מחרוזת' },
  159: { claim: '⏳' },
  47: { manual: 'התאמת הערה למציאות אינה ניתנת לאכיפה מכנית' },
  161: { claim: 'כל קובץ בעץ מוזכר במקום אחר' },
  166: { claim: 'ד. רשימת-היתר' },
  168: { manual: 'מצב הענפים המרוחקים אינו נראה מעותק העבודה' },
  ...
  88: { manual: '«קורא סביר יופתע» אינו נגזר מהטקסט — ⛔ נאכף בתוצאתו בלבד' },
  96: { claim: 'CLEANUP_SHA' },
  97: { claim: 'בלוק ה-APP' },
  146: { claims: { 'check-capabilities': 'cfgKeyGaps', test_dbfacts: 'ג. כל מפתח שהקוד מבקש' } },
};
