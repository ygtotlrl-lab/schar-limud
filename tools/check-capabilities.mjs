...
const APP = {
  ...
  gapRows: [47, 78, 129, 133, 157, 167, 64, 174, 142, 93],
  ...
  tableProbe: {
     ...
     *  ניתנת למדידה במלואה. */
    178: (c) => c.hasCode(/SL_PASS_ITER_USER\s*=\s*100000\b/)
...
const FLOOR = { shared: 84, app: 10, appWhy: 'כניסה — סשן · נעילה · הרשאות · כתיבת משתמש · שכבת המראה; ומעליהם שני בלוקי גרף העמודות' };
/* ⚠️ סוף פר-אפליקציה */
