...
const APP = {
  ...
  gapRows: [41, 73, 116, 120, 142, 151, 59, 158, 129],
  ...
  tableProbe: {
     ...
     *  ניתנת למדידה במלואה. */
    162: (c) => c.hasCode(/SL_PASS_ITER_USER\s*=\s*100000\b/)
...
const FLOOR = { shared: 164, app: 9, appWhy: 'כניסה — סשן · נעילה · הרשאות · כתיבת משתמש · שכבת המראה; ומעליו שער מצב הרשת' };
/* ⚠️ סוף פר-אפליקציה */
