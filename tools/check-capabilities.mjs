...
const APP = {
  ...
  gapRows: [41, 74, 117, 121, 143, 152, 59, 159, 130],
  ...
  tableProbe: {
     ...
     *  ניתנת למדידה במלואה. */
    163: (c) => c.hasCode(/SL_PASS_ITER_USER\s*=\s*100000\b/)
...
const FLOOR = { shared: 165, app: 9, appWhy: 'כניסה — סשן · נעילה · הרשאות · כתיבת משתמש · שכבת המראה; ומעליו שער מצב הרשת' };
/* ⚠️ סוף פר-אפליקציה */
