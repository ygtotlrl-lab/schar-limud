...
const APP = {
  ...
  gapRows: [226, 80, 140, 144, 168, 179, 66, 187, 153, 99],
  ...
  tableProbe: {
     ...
     *  ניתנת למדידה במלואה. */
    191: (c) => c.hasCode(/SL_PASS_ITER_USER\s*=\s*100000\b/)
...
const FLOOR = { shared: 87, app: 10, appWhy: 'כניסה — סשן · נעילה · הרשאות · כתיבת משתמש · שכבת המראה; ומעליהם שני בלוקי גרף העמודות' };
/* ⚠️ סוף פר-אפליקציה */
