...
const APP = {
  ...
  actMap: 'DOM_ACTIONS',
  gapRows: [38, 68, 105, 109, 127, 128, 132, 135, 143, 145],
   ...
   *  ⭐ וההשוואה על **הערך** ⛔ ולא על מזהה: ⚠️ **והרשימה אינה נשמטת** —
  ...
  tableProbe: {
     ...
     *  ניתנת למדידה במלואה. */
    147: (c) => c.hasCode(/SL_PASS_ITER_USER\s*=\s*100000\b/)
