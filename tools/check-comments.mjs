...
const APP = {
  ...
  /*  ⛔ מנוע התאריך העברי נעדר כאן במכוון (סבב 107) — ⚠️ אפס צרכני
   *  תאריך עברי, ⭐ ומודול שאין לו קורא הוא קוד מת. */
  skipBlocks: ['מנוע התאריך העברי — מודול משותף (סבב 107)'],
};
/* ── סוף APP ───────────────────────────────────────────────────────────── */
...
export const ROWS = [16, 20, 18, 19, 30, 31, 32, 25, 36, 42, 45, 90, 92, 93, 98];
