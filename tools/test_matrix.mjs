...
const FLOOR = { shared: 234, app: 0, appWhy: '' };
/* ⚠️ סוף פר-אפליקציה */
...
const EXEMPT = [
  18, 19, 23, 24, 25, 30, 33, 34, 35, 39, 40, 45, 47, 49, 51, 54, 58, 60,
  61, 62, 68, 73, 85, 91, 92, 94, 97, 107, 115, 118, 121, 122, 123, 124, 125,
  126, 138, 139, 141, 144, 159, 168, 170, 172, 180, 181, 184, 192, 193, 199,
  204, 212, 214, 215, 218, 219, 220, 224, 225, 226, 233
];
